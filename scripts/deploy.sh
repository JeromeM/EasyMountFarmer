#!/usr/bin/env bash
# Deploy the MountRoadmap addon folder into your WoW retail AddOns directory.
...
rm -rf "$DEST/MountRoadmap"
cp -r "$SRC" "$DEST/MountRoadmap"
echo "Deployed to: $DEST/MountRoadmap"
