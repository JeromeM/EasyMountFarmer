#!/usr/bin/env bash
# Deploy the EasyMountFarmer addon folder into your WoW retail AddOns directory.
...
SRC="$SCRIPT_DIR/../EasyMountFarmer"
...
rm -rf "$DEST/EasyMountFarmer"
cp -r "$SRC" "$DEST/EasyMountFarmer"
echo "Deployed to: $DEST/EasyMountFarmer"
